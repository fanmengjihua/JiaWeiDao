...
import { w as createVNode, F as Fragment, aJ as __astro_tag_component__ } from './astro/server_Cgw2UP0D.mjs';
import { j as jsxRuntimeExports, h as humanize, k } from './Base_DN9ImJ8y.mjs';
import { a as reactExports } from './_@astro-renderers_93vWgF-o.mjs';
...
const Youtube = ({
  ...
  reactExports.useEffect(() => {
    import('./lite-youtube_vOmU7X16.mjs');
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("lite-youtube", { className: "rounded-lg", videoid: id, videotitle: title, ...rest });
};
...
const url = "/elements";
const file = "I:/阿里云盘下载/Astro-main/Astro-main/src/content/pages/elements.mdx";
...
Content.moduleId = "I:/阿里云盘下载/Astro-main/Astro-main/src/content/pages/elements.mdx";
