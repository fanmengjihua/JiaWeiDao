...
import { g as getSinglePage } from './contentParser_B-CJRfij.mjs';
import { d as dateFormat } from './dateFormat_B6sxLX_1.mjs';
import { p as plainify, s as slugify, h as humanize } from './Base_DN9ImJ8y.mjs';
import { $ as $$Image } from './_astro_assets_pp92rEe0.mjs';
import { B as BiCalendarEdit, a as BiCategoryAlt } from './index_C-L1enFo.mjs';
import { c as categoryMapping } from './categoryMapping_buvMakVE.mjs';
...
const $$Posts = createComponent(async ($$result, $$props, $$slots) => {
  ...
  })} </ul> </li> </ul> <h3 class="mb-4"> <a${addAttribute(`/blog/${post.id}`, "href")} class="block hover:text-primary transition duration-300"> ${post.data.title} </a> </h3> <p class="text-text line-clamp-2">${plainify(post.body ?? "")}</p> </div>`)} </div>`;
}, "I:/\u963F\u91CC\u4E91\u76D8\u4E0B\u8F7D/Astro-main/Astro-main/src/layouts/components/Posts.astro", void 0);
